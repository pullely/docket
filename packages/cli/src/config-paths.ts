...
//   - `~/.config/docket/credentials.json` (0600)
//   - `~/.config/docket/config.json`     (0644)
//
// Override via `DOCKET_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/docket` everywhere
