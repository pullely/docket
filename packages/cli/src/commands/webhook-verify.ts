// `docket webhook verify` — local cryptographic verification of a
// docket outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `docket login`.
