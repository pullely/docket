// Typed error hierarchy for the docket SDK.
//
...
// codes (forward compatibility) fall back to the generic `docketError`
...
export interface docketErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof docketError`
 * still matches.
 */
export class docketError extends Error {
  ...
  constructor(init: docketErrorInit) {
...
export class BadRequestError extends docketError {
  constructor(init: docketErrorInit) {
    super(init);
...
export class UnauthenticatedError extends docketError {
  constructor(init: docketErrorInit) {
    super(init);
...
export class ForbiddenError extends docketError {
  constructor(init: docketErrorInit) {
    super(init);
...
export class NotFoundError extends docketError {
  constructor(init: docketErrorInit) {
    super(init);
...
export class ConflictError extends docketError {
  constructor(init: docketErrorInit) {
    super(init);
...
export class ValidationError extends docketError {
...
export class PreconditionFailedError extends docketError {
  constructor(init: docketErrorInit) {
    super(init);
...
export class UnsupportedError extends docketError {
  constructor(init: docketErrorInit) {
    super(init);
...
export class InternalError extends docketError {
  constructor(init: docketErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends docketErrorInit {
...
export class RateLimitError extends docketError {
...
/**
 * Decode an HTTP `Response` into the appropriate `docketError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `docketError`.
...
export async function decodeError(
  ...
  switch (envelope.code as ErrorCode) {
    ...
    default:
      ...
      return new docketError(init);
  }
}

function decodeRateLimit(
  init: docketErrorInit,
  response: Response,
): RateLimitError {
