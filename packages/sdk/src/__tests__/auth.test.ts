...
//   - docketError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): docket {
  return new docket({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the docket class", () => {
