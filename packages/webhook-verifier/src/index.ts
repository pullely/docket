 ...
 * signature verifier for docket outbound webhook deliveries.
 *
...
/**
 * Compute the canonical docket webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a docket webhook delivery.
 *
