...
Next.js 15 + [opennextjs/cloudflare](https://github.com/opennextjs/opennextjs-cloudflare) delivery of the docket web console.
...
- Per-env Cloudflare Pages projects: `docket-web-console-next-{dev,stage,prod}`
